...
Here's what I am finally starting to realize after months of frustration: prompts are suggestions. The model follows them most of the time — I'll give it that — but "most of the time" isn't good enough when you're trying to ship real software. It is not totally good at all when 
