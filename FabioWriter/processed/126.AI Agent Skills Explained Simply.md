# AI Agent Skills Explained Simply. AI agent skills add procedural… | by Tahir | Apr, 2026 | Medium
...
](/@tahirbalarabe2?source=post_page---byline--4010f6d9db92---------------------------------------)

[Tahir](/@tahirbalarabe2?source=post_page---byline--4010f6d9db92---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:700/1*vdYEFOYfAj635SkF3sh2EQ.png)
...
[**WHAT ARE AGENT SKILLS?**](/@tahirbalarabe2/what-are-agent-skills-c7793b206daf)
...
[Agent Skills are modular capabilities that extend LLM’s functionality.](/@tahirbalarabe2/what-are-agent-skills-c7793b206daf) They’re reusable, filesystem-based resources containing instructions, metadata, and optional resources (scripts, templates) that Claude automatically uses when relevant to your request.
...
![](https://miro.medium.com/v2/resize:fit:700/1*7fzkAir00J7M_PF63prFTg.png)
...
[What is LLM Wiki Pattern? Persistent Knowledge with LLM Wikis](/@tahirbalarabe2/what-is-llm-wiki-pattern-persistent-knowledge-with-llm-wikis-3227f561abc1)

[🐍 LiteLLM PyPI Supply Chain Attack Detection and Remediation](/@tahirbalarabe2/litellm-pypi-supply-chain-attack-detection-and-remediation-cef5e99270ed)

[🐍The LiteLLM PyPI Supply Chain Attack What You Need to Know](/@tahirbalarabe2/the-litellm-pypi-supply-chain-attack-what-you-need-to-know-6ab536d4aeb3)

[What is Moltbook? The Social Network for Ai Agents](/@tahirbalarabe2/what-is-moltbook-the-social-network-for-ai-agents-12f7a28a2d12)

[What is Clawdbot(Moltbot)?](/@tahirbalarabe2/what-is-moltbook-the-social-network-for-ai-agents-12f7a28a2d12)

[🦞(Clawdbot) MoltBot OpenClaw Local System Architecture](/@tahirbalarabe2/clawdbot-moltbot-openclaw-local-system-architecture-52acc37f1213)

[WHAT ARE AGENT SKILLS?](/@tahirbalarabe2/what-are-agent-skills-c7793b206daf)

[Agent Skills Vs MCP Vs Prompts Vs Projects Vs Subagents :A Comparative Analysis](/@tahirbalarabe2/agent-skills-vs-mcp-vs-prompts-vs-projects-vs-subagents-a-comparative-analysis-7a36cd85cb74)

[⌨️ What is LLM Prompt Engineering?](/@tahirbalarabe2/%EF%B8%8F-what-is-llm-prompt-engineering-e80c59bd522e)

[📈 Prompt Engineering Made Simple with the RISEN Framework](/@tahirbalarabe2/prompt-engineering-made-simple-with-the-risen-framework-038d98319574)

[💡 What is Prompt Engineering ?:: RAG, CoT, ReAct & DSP Explained](/@tahirbalarabe2/what-is-prompt-engineering-rag-cot-react-dsp-explained-0aa0a9bd0a90)

[🔗What is Model Context Protocol? (MCP) Architecture Overview](/@tahirbalarabe2/what-is-model-context-protocol-mcp-architecture-overview-c75f20ba4498)

[How DRIFT Stops Prompt Injection Attacks in LLM Agents](/@tahirbalarabe2/how-drift-stops-prompt-injection-attacks-in-llm-agents-9454368f5e4c)

[Implementing Secure by Design Principles in AI System Development](/@tahirbalarabe2/implementing-secure-by-design-principles-in-ai-system-development-5ea2d199bb28)

[How to Build an Enterprise AI Compliance Program](/@tahirbalarabe2/how-to-build-an-enterprise-ai-compliance-program-58aba0861651)

[🕵️How to Monitor AI Models in Production](/@tahirbalarabe2/%EF%B8%8Fhow-to-monitor-ai-models-in-production-2f29820094f3)

[⚙️AWS Well-Architected Best Practices](/@tahirbalarabe2/%EF%B8%8Faws-well-architected-best-practices-5c36c6a9cde6)

[Building Cloud Agnostic Resilience After AWS Outage](/@tahirbalarabe2/building-cloud-agnostic-resilience-after-aws-outage-7dbe1f04becc)

[Building Secure AI Agents with Data Governance](/@tahirbalarabe2/building-secure-ai-agents-with-data-governance-dc7865eab9f7)

[Part 1: Building AI Data Governance](/@tahirbalarabe2/building-ai-data-governance-with-databricks-unity-catalog-e1d5ed4cab2f)

[**Part 2: Building The HR Agent**](/@tahirbalarabe2/build-your-ai-agent-with-tool-calling-5111eab61521)

[Part 3: Evaluating and Deploying the HR Analytics Agent](/@tahirbalarabe2/evaluating-and-deploying-ai-agent-0e878e27cc7f)

[How to Build a Secure Enterprise Sovereign AI Factory with Open-Source.](/@tahirbalarabe2/how-to-build-a-secure-enterprise-sovereign-ai-factory-with-open-source-361990805673)

[Build AI Customer Support Agents with PydanticAI](/@tahirbalarabe2/building-type-safe-ai-agents-with-pydanticai-fee757c6a00f)

[⚙️LangChain vs. LangGraph: A Comparative Analysis](/@tahirbalarabe2/%EF%B8%8Flangchain-vs-langgraph-a-comparative-analysis-ce7749a80d9c)

[🔗What is Model Context Protocol? (MCP) Architecture Overview](/@tahirbalarabe2/deepseek-r1-explained-chain-of-thought-reinforcement-learning-and-model-distillation-0eb165d928c9)

[🚀DeepSeek R1 Explained: Chain of Thought, Reinforcement Learning, and Model Distillation](/@tahirbalarabe2/deepseek-r1-explained-chain-of-thought-reinforcement-learning-and-model-distillation-0eb165d928c9)

[💻What is Ollama: Running Large Language Models Locally](/@tahirbalarabe2/what-is-ollama-running-large-language-models-locally-e917ca40defe)

[Model Context Protocol (MCP) vs. APIs: The New Standard for AI Integration](/@tahirbalarabe2/model-context-protocol-mcp-vs-apis-the-new-standard-for-ai-integration-d6b9a7665ea7)

[🧠Understanding LLM Context Windows: Tokens, Attention, and Challenges](/@tahirbalarabe2/understanding-llm-context-windows-tokens-attention-and-challenges-c98e140f174d)
