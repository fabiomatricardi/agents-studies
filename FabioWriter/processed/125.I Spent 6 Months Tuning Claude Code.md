# I Spent 6 Months Tuning Claude Code. Here’s the Exact Setup That Finally Worked. | by Anubhav | Data Science Collective | Apr, 2026 | Medium
...
![Anubhav](https://miro.medium.com/v2/resize:fill:64:64/1*a96ICyCx5Xa078adPFbp5A.jpeg)

](/@anubhavgoyal101?source=post_page---byline--b41c67628478---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:700/1*4s57FLS9lKdBJLo-SvMKWg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*PfVlfQpEYfnWhG2F3Y1-hw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*jninS4CR31UMBX4y0W3JXw.png)
...
_(Note: While_ `_paths:_` _is the documented schema key, current versions sometimes drop it due to a known bug. Using_ `_globs:_` _or a CSV format works more reliably in practice if you notice your rules being silently ignored)._
...
![](https://miro.medium.com/v2/resize:fit:700/1*MnfMB_EFXEJeeZl2En1l9A.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*9LMmcsni6r7lAdVErm17Bg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*bTRUHSNwdnScsmjqOoYz8w.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*xSXoKNpDj1_tM8DIL6j2FQ.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*yJ39BH_m9J5P17oXmkULCw.png)
