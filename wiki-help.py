...
```bash
git remote add origin https://github.com/fabiomatricardi/agents-studies.git
```
...
while True:
    console.print(md_menu)
    u_choice = input("Select a number: ").strip()  # Also strip whitespace
    
    if u_choice == "0":
        console.print("BYE")
        break
    elif u_choice == "1":
        console.print(md_llamaserver)
    elif u_choice == "2":
        console.print(md_batexamples)
    elif u_choice == "3":
        console.print(md_github)
    elif u_choice == "4":
        console.print(md_ipython)
    else:
        console.print("[red]> WRONG CHOICE[/red]")  # Optional: Rich styling
