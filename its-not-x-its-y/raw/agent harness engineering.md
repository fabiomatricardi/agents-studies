# (21) Addy Osmani on X: "Agent Harness Engineering" / X
...
coined the term harness engineering, providing a clean breakdown of what a harness actually is and why each piece exists. Other industry voices like

[@dexhorthy](https://x.com/@dexhorthy)

tracking emergent patterns, HumanLayer framing agent failures as configuration "skill issues" Anthropic's engineering team publishing guides on long-running app design, and Birgitta Böckeler exploring the user-side experience - are all convergng on roughly the same idea.
...
![Image](https://pbs.twimg.com/media/HH6JkuzaEAAYR1T?format=jpg&name=small)

](/addyosmani/article/2053231239721885918/media/2053229744259469312)
...
![Image](https://pbs.twimg.com/media/HH6JvwebkAAT69Y?format=jpg&name=small)

](/addyosmani/article/2053231239721885918/media/2053229933686919168)
...
The clearest public picture I’ve seen of a mature harness is Fareed Khan’s (estimated) breakdown of

[Claude Code’s architecture](https://levelup.gitconnected.com/building-claude-code-with-harness-engineering-d2e8c0da85f0)

.

[

![Image](https://pbs.twimg.com/media/HH6KJ_rbQAAQw-_?format=jpg&name=small)

](/addyosmani/article/2053231239721885918/media/2053230384444555264)
...
If you are a looking for a great agent harness framework,

[@FredKSchott](https://x.com/@FredKSchott)

wrote

[Flue](https://x.com/FredKSchott/status/2050274923852210397)